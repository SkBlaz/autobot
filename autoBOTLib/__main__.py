...
def main():
    ...
    parser.add_argument(
        ...
        default=0.1,
        type=float,
        help="Time in hours. Suggested value for real sota performances >= 1")
    ...
    parser.add_argument(
        ...
        type=str,
        help="Representation type. See the docs for more info.")
    parser.add_argument("--train_data",
                        default="./data/insults/train.tsv",
                        type=str)
    ...
    parser.add_argument(
        ...
        default=False,
        type=bool,
        help="Minority class upsampling, might substantially boost performance!"
    )
    parser.add_argument(
        "--mode",
        default="learning",
        type=str,
        help=
        "Learning or prediction. Prediction requires a path to a trained model."
    )
...
#    args.time
    ...
    if args.mode == "prediction":
        ...
        logging.info(
            f"Storing the model as {args.output_folder}/autoBOTmodel.pickle")

        autoBOTLib.store_autobot_model(
            autobotlibObj, f"{args.output_folder}/autoBOTmodel.pickle")

        try:
            autobotlibObj.generate_report(
                output_folder=f"{args.output_folder}", job_id=args.job_id)
